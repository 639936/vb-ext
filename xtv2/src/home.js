function execute() {
    return Response.success([
        ...
        {title: "Top 1000 truyện sex được đọc nhiều nhất", input: BASE_URL + "/top-1000-truyen-sex-duoc-doc-nhieu-nhat", script: "gen.js"},
        {title: "Top tác giả tài năng", input: BASE_URL, script: "tg.js"},
    ]);
}