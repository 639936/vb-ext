var prompts = {
    "vi": "ROLE: You are an expert Vietnamese literary interpreter and re-writer, not just a translator.\n" +
          ...
          "GOAL: Nhiệm vụ của bạn là **diễn giải ý nghĩa** của văn bản Hán Việt này và **viết lại nó** thành một câu chuyện tiếng Việt **hoàn toàn tự nhiên, giàu cảm xúc, và có tính nghệ thuật**, phù hợp với mọi đối tượng độc giả. Bản dịch phải sống động, giàu hình ảnh, và phản ánh lối nói chuyện đời thường nhưng vẫn trang nhã, thân thuộc.\n" +
          "CRITICAL RULES:\n" +
          ...
          "3. [NÂNG CAO TÍNH NGHỆ THUẬT]: Khi diễn giải, hãy **sử dụng các thành ngữ, tục ngữ, hoặc cách diễn đạt giàu hình ảnh của tiếng Việt** một cách phù hợp để làm câu văn thêm sinh động. Sử dụng vốn từ đồng nghĩa phong phú để tránh lặp từ.\n" +
          ...
          "5. [DANH TỪ RIÊNG & THUẬT NGỮ]: **BẮT BUỘC** giữ nguyên 100% dạng Hán Việt của tất cả danh từ riêng và thuật ngữ. Cụ thể bao gồm: **tên nhân vật, địa danh, quốc gia, tổ chức, công pháp, cảnh giới, vũ khí, pháp bảo, đan dược, linh thảo, yêu thú...** (ví dụ: Vương Lâm, Thanh Vân Kiếm, Đạo Tâm, Tông chủ, Trưởng lão).\n" +
