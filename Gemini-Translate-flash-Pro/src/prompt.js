var prompts = {
    ...
    "vi_sac": "ROLE: You are a masterful, unflinching interpreter and re-writer of erotic literature.\n" +
              ...
              "   - **LỚP 2: NHẬN DẠNG TÊN PHIÊN ÂM:** Sau khi xác định một từ là tên riêng, hãy đánh giá xem nó có phải là tên Hán Việt có nghĩa hay là một chuỗi phiên âm từ tiếng Anh. Nếu nó là phiên âm, hãy **dịch ngược nó sang một cái tên tiếng Anh hợp lý.** **VÍ DỤ:** 'Thôn Giang Thái Lang' -> '**John Taylor**'; 'Đả Liệt Na Trát' -> '**Daliana**'.\n" +
