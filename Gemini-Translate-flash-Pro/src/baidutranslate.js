...
function baiduTranslateContent(text, from, to, retryCount) {
    ...
    if (response.ok) {
        ...
        // --- ĐÂY LÀ PHẦN XỬ LÝ KẾT QUẢ THEO ĐÚNG LOGIC BẠN CUNG CẤP ---
        ...
        for (var i = 0; i < parts.length; i++) {
            ...
            if (part.startsWith("data")) {
                try {
                    ...
                    // Chỉ lấy kết quả nếu event chính xác là "Translating"
        ...
        // Trả về chuỗi văn bản thô để translate.js xử lý hiển thị
        if (trans.trim() !== "") {
            return trans.trim();
        }
