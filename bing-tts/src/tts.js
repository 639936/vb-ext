...
function generateSSML(text, voiceLang, voiceName, voiceGender) {
    ...
    return "<speak version='1.0' xml:lang='" + voiceLang + "'><voice xml:lang='" + voiceLang + "' xml:gender='" + voiceGender + "' name='" + voiceName + "'><prosody rate='0%' volume='x-loud'>" + escapeXml(text) + "</prosody></voice></speak>"
}
